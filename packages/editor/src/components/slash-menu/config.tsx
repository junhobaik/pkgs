...
export const config: Array<ConfigItem> = [
  {
    ...
    renderer: (
      <div className="flex items-center gap-2">
        <span className="material-symbols-outlined text-nord-10 dark:text-nord-9">format_h1</span>
        Large Heading
      </div>
    ),
  },
  {
    ...
    renderer: (
      <div className="flex items-center gap-2">
        <span className="material-symbols-outlined text-nord-10 dark:text-nord-9">format_h2</span>
        Medium Heading
      </div>
    ),
  },
  {
    ...
    renderer: (
      <div className="flex items-center gap-2">
        <span className="material-symbols-outlined text-nord-10 dark:text-nord-9">format_h3</span>
        Small Heading
      </div>
    ),
  },
  {
    ...
    renderer: (
      <div className="flex items-center gap-2">
        <span className="material-symbols-outlined text-nord-10 dark:text-nord-9">data_object</span>
        Code Block
      </div>
    ),
  },
